...
class TaskRepository @Inject constructor(
        ...
        return try {
            ...
            if (currentUser != null) {
                ...
                notificationRecipients.forEach { recipientId ->
                    ...
                    notificationRepository.createNotification(notification)
                    Log.d(TAG, "Created status change notification for recipient: $recipientId")
                }
            }
    ...
    suspend fun addTaskAttachment(
        ...
        return storageService.uploadTaskFile(projectId, taskId, uri)
    }

    suspend fun updateTaskWithAttachments(
        taskId: String,
    ...
    suspend fun deleteTaskAttachment(
        ...
        storageService.deleteFile(projectId, "tasks/$taskId/$attachmentId")
    }
